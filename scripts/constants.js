...
cehqConstants.constant( 'mainMenuAnonymous', [
 /* { label: 'Home',            page: 'home' },
  ...
  { label: 'Program Management',   page: 'programview' },
...
cehqConstants.constant( 'mainMenuSignedIn', [
  ...
  { label: 'Topic Search',      page: 'topic' },
  { label: 'Site Management',   page: 'site' },
  { label: 'Credit Management', page: 'credit' },
  { label: 'My Profile',        page: 'profile' },
  { label: 'Feedback',          page: 'feedback' }
]);

cehqConstants.constant( 'rightMenuSignedIn', [
  { label: 'Sign Out', page: 'signout' }
]);
...
cehqConstants.constant( 'appConstants', {
  ...
  BASE_URL: 'http://54.191.240.64:8080'
